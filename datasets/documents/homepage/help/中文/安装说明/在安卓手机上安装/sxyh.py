...
HTTPD_CONF = "/data/data/com.termux/files/home/storage/shared/Documents/httpd.conf.1"
...
print("1. 安装系统服务：termux-services\n")
run_external_command("apt-get install -y termux-services")

print("2. 安装 apache2、php 和 php-apache\n")
