  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col s12 hide-on-large-only">
        <p class="center-align"><small>This page was last edited on <?= wdf_timestamp_format($DOC->TIMESTAMP,"Y-m-d H:i") ?><br><?php if(Session::getInstance()->isAuthenticated()){echo $pageview.'&nbsp;&nbsp;'.$pagenumber.'<br>'.$wikistat.'<br>';} ?><br><a href="<?= $APP->PATH ?>randpage.php" title="<?= $TXT->RandPage ?>">🔀</a>&nbsp;&nbsp;<?php echo $RecentLink; ?>&nbsp;&nbsp;<a href="#" class="about-link" title="<?= $TXT->About ?>"><b>⛵² </b></a></small></p>
    ...
    <div id="about-dialog" class="about-dialog">
        ...
        <p><img src="<?= $APP->PATH ?>favicon.ico" align="left" class="logo-image"> <span style="font-size:30px;"><b><?= $TXT->FreeNavigation ?></b></span> &emsp;v2.2.0<br><?= $TXT->RunOn?> <a href="<?= $APP->PATH ?>"><?php echo $_SERVER['HTTP_HOST']; ?></a></p>
